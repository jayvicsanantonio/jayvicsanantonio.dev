...
export default function NotFoundPage() {
  return (
    <div className="w-full m-0">
      <div className="-mt-20 lg:mt-12 lg:mx-28 text-center">
        <Image
          src="/images/404.webp"
          alt="404"
          width={400}
        ...
        <Link
          href="/"
          className="hover:text-blue-400 underline decoration-wavy decoration-purple-500 underline-offset-4 text-sm lg:text-lg"
        >
          Go to Homepage
        </Link>
      </div>
