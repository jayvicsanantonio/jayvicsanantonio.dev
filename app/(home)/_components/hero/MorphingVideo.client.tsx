  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div
className="relative flex h-14 w-[var(--nav-row-w)] items-center justify-center rounded-[384px] glass-base before:pointer-events-none before:absolute before:inset-0 before:bg-[radial-gradient(120%_60%_at_50%_0%,rgba(255,255,255,0.35),rgba(255,255,255,0)_60%)] before:content-[''] sm:h-full sm:w-full"
            style={{
              background:
