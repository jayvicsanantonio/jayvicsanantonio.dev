...
export default function MobileNavRow() {
  return (
    ...
    >
      <GlassButton href="/projects" aria-label="Projects" className="vt-tag-projects h-14 w-14">
      ...
      <GlassButton href="/work" aria-label="Work Experience" className="vt-tag-work h-14 w-14">
