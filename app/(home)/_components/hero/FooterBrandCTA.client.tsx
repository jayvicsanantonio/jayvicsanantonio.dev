  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-6">
        ...
        <Link
          href="/work"
          className="pointer-events-auto min-h-11 rounded-full bg-white px-6 py-2 text-sm font-medium text-black transition-all duration-300 hover:scale-105 hover:bg-white/90 sm:px-6 sm:py-2.5 sm:text-sm md:py-3 md:text-base"
        >
          Work Experience
        </Link>
      </div>
