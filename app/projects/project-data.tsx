...
export const PROJECTS: Project[] = [
    ...
    sections: [
      {
        ...
        content: (
          <>
            A modern implementation of the classic Pac-Man game, built to explore React 19 features,
            state management with hooks and context, and simple game AI.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Utilized React 19 for modern features, TypeScript for type safety, Vite for a fast
            development environment, and Tailwind CSS for styling. Implemented game logic including
            collision detection, power-up modes, and basic ghost AI.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            A playable demo showcasing a complete game loop, responsive controls, and functional
            AI-driven opponents.
          </>
        ),
      },
    ...
    sections: [
      {
        ...
        content: (
          <>
            An interactive timeline of AI history, designed to be performant and accessible, built
      ...
      },
      {
        ...
        content: (
          <>
            Utilized Next.js 15 for its performance features, TypeScript for type safety, and Framer
            Motion for smooth animations. Ensured WCAG compliance for accessibility.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            A fast, engaging, and accessible timeline that visually represents key moments in AI
            history.
          </>
        ),
      },
    ...
    sections: [
      {
        ...
        content: (
          <>
            Core developer across RTB tools and audience systems. Owned performance-critical flows
            and mentored engineers while evolving frameworks (Ember→modernized stacks).
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Introduced resilient upload pipeline patterns, reusable UI primitives, and CI-friendly
            end‑to‑end testing with Cypress to reduce flakiness and accelerate feedback.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Increased audience upload capacity from 2M → 25M records; contributed to features that
            drove material spend; improved developer velocity and product reliability.
          </>
        ),
      },
    ],
    ...
    sections: [
      {
        ...
        content: (
          <>
            Built for daily use with balanced syntax color roles and consistent UI surfaces.
            Prioritized clarity and theme cohesion across states.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Crafted palette pairs with measured saturation; tuned selection/hover backgrounds;
            hardened readability for long sessions.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Positive adoption and reuse patterns; approachable and fun without compromising
    ...
    sections: [
      {
        ...
        content: (
          <>
            Designed variants that feel related yet distinct, preserving familiarity across modes.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Shared base hues with divergent accents; considered whitespace and contrast ergonomics.
          </>
        ),
      },
      {
        label: 'Results',
        content: (
          <>Stable, readable themes with personality; easy to switch without visual fatigue.</>
        ),
      },
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: (
          <>
            Chose a lightweight React stack with accessible components and clear content hierarchy.
          </>
        ),
      },
      {
        label: 'Results',
        content: <>Improved discoverability of sermons and events; consistent UX across devices.</>,
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        content: (
          <>
            Designed to feel instantaneous across ecosystems. Built for consistency, conflict
            resolution, and fault‑tolerant event delivery.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Chose Vercel edge + Hono for proximity; leveraged OAuth + webhooks with Redis‑backed
            state to minimize polling and avoid drift.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Smooth two‑way sync, responsive UX under network variability, and a portable
            architecture that can extend to other providers.
          </>
        ),
      },
    ],
    ...
    sections: [
      {
        ...
        content: (
          <>
            Personal project focused on building sustainable habits through visual progress tracking
            and goal setting.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Built with a clean, intuitive interface prioritizing ease of use and consistent
            engagement patterns.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Delivered a functional habit tracker with streak visualization and goal management
            capabilities.
          </>
        ),
      },
    ...
    sections: [
      {
        ...
        content: (
          <>
            Built to onboard engineers quickly and reduce search friction. Focused on clarity and
            navigability.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Lightweight stack with accessible components and semantic markup. Emphasis on category
            IA and scanning speed.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Faster discovery of quality resources; repeatable curation model; easy contribution
            flow.
          </>
        ),
      },
  ...
  },
  {
    ...
    sections: [
      {
        label: 'Context',
        content: <>Built to extend access to credit by bringing bank lending flows to mobile.</>,
      },
      {
        label: 'Decisions',
        content: (
          <>
            Focused on secure, streamlined journeys and an API-first integration surface for
            participating banks.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Enabled scalable distribution of loan products across geographies via a single mobile
            experience.
          </>
        ),
      },
    ...
    sections: [
      {
        ...
        content: (
          <>
            Designed and supported the infrastructure for an IoT wearable focused on personal
            safety, with a companion Android application.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Chose BLE for low-power connectivity; implemented a Node.js + Express backend on AWS to
            provide reliable APIs and telemetry processing.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Delivered a responsive device–app experience with a scalable cloud backend and
    ...
    sections: [
      {
        ...
        content: (
          <>
            Contributed to a community resource that streamlines upgrading Ember apps by surfacing
            changes between versions and recommended migration steps.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Focused on clarity and accuracy of guidance; emphasized a developer‑friendly UX to
            minimize friction during upgrades.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Increased confidence and speed of framework upgrades across teams adopting modern Ember
            patterns.
          </>
        ),
      },
    ...
    sections: [
      {
        ...
        content: (
          <>
            Collaborated on a large-scale consumer app for T.A.P.E., integrating social feeds and
            delivering the Pinoy Henyo multiplayer experience to mobile.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Used Node and SailsJS with Redis and MongoDB to handle spikes in concurrent requests;
            optimized for reliability and low-latency interactions.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Successfully launched for the show’s 35th anniversary with strong adoption and
            engagement.
          </>
        ),
      },
    ...
    sections: [
      {
        ...
        content: (
          <>
            Helped evolve an enterprise-grade content platform serving Philippine basketball fans
            with fresh updates and features.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Used Express and Node with MongoDB and Redis for fast page delivery and caching;
            streamlined templating and UI with jQuery and CSS.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Delivered a responsive, reliable experience that handled bursts of traffic around major
            games and events.
          </>
        ),
      },
