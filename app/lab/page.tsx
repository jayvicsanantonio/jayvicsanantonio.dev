    ...
    <section className="mx-auto w-full  dark:bg-gray-950 dark:text-gray-200">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-8 py-12  dark:bg-gray-950 text-gray-200">
          <Card className="flex flex-col h-full border-transparent dark:bg-gray-950 rounded-lg overflow-hidden shadow-md hover:scale-105 ease-in duration-300 motion-reduce:transition-none motion-reduce:hover:transform-none">
