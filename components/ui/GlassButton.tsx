...
import { getTouchOptimizedClasses, getHoverOptimizedClasses } from '@/lib/utils/touchOptimization';
    ...
    return (
      <Link
        ...
        className={cn(
          ...
          // Safari-optimized glass effects
          getOptimizedGlassClasses('button', false, false),
          // Touch optimizations for mobile Safari
          getTouchOptimizedClasses({ preventZoom: true, fastTap: true }),
          ...
          getHoverOptimizedClasses(
            'hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_10px_36px_rgba(0,0,0,0.26)]',
            'active:shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_10px_36px_rgba(0,0,0,0.26)] active:scale-98'
          ),
          className,
        )}
      >
