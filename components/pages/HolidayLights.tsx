      ...
      >
        <defs>
          ...
          <g id="holiday-lights" clipPath="url(#a)">
            ...
            />
            <g className="bulb-glow red" filter="url(#b)" style={{ mixBlendMode: 'plus-lighter' }}>
            ...
            <g id="bulb-red">
              ...
              <g filter="url(#f)" opacity=".6" style={{ mixBlendMode: 'plus-lighter' }}>
                <path
                  fill="#fff"
            ...
            <g className="bulb-glow blue" filter="url(#g)" style={{ mixBlendMode: 'plus-lighter' }}>
            ...
            <g id="bulb-blue">
              ...
              <g filter="url(#k)" opacity=".6" style={{ mixBlendMode: 'plus-lighter' }}>
                <path
                  fill="#fff"
            ...
            <g id="bulb-yellow">
              ...
              <g filter="url(#p)" opacity=".6" style={{ mixBlendMode: 'plus-lighter' }}>
                <path
                  fill="#fff"
            ...
            <g id="bulb-green">
              ...
              <g filter="url(#u)" opacity=".6" style={{ mixBlendMode: 'plus-lighter' }}>
