              ...
              >
                ...
                <div className="space-y-2 text-left">
                  ...
                  <p className="dark:text-gray-300 line-clamp-3">
                    The Popover API lets you easily create and control
                    those handy content bubbles that pop up on
                    webpages, offering improved accessibility and
                    standardization for a smoother user experience.
                  </p>
            ...
            >
              ...
              >
                ...
                <div className="space-y-2 text-left">
                  ...
                  <p className="dark:text-gray-300 line-clamp-3">
                    The :user-valid and :user-invalid CSS
                    pseudo-classes give instant visual feedback on
                    form input, improving usability and accessibility
                    by highlighting correct and incorrect entries.
                  </p>
                  <div className="mt-6 flex flex-wrap gap-2">
                    <Badge className="text-sm" variant="secondary">
                      Advent Calendar
            ...
            >
              ...
              >
                ...
                <div className="space-y-2 text-left">
                  ...
                  <p className="dark:text-gray-300 line-clamp-3">
                    Autofocus in HTML automatically places the cursor
                    in a form field, making user interaction smoother.
                    Use it wisely, though, as overuse can be annoying
                    and even cause accessibility issues.
                  </p>
                  <div className="mt-6 flex flex-wrap gap-2">
                    <Badge className="text-sm" variant="secondary">
                      Advent Calendar
