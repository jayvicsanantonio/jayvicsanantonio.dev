...
export default function Header({
  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 mt-12 md:mt-14 lg:mt-16 xl:mt-24 bg-white dark:bg-gray-950/80 bg-white/80 backdrop-blur-md border rounded-3xl dark:border-gray-800 sticky top-4 z-10 -mx-4 lg:-mx-auto frosted">
