...
export default function HeroMorph() {
  ...
  return (
    <div ref={containerRef} className="relative overflow-x-hidden bg-black">
      ...
      {initialPill && (
        <div className="fixed z-[60] left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none" style={{ top: "46%" }}>
          <div
          ...
          >
            <span className="font-semibold tracking-wide" style={{ color: "black", fontSize: "clamp(14px, 2.1vw, 22px)" }}>
              Hi, I'm Jayvic 👋
            </span>
          </div>
        </div>
      ...
      <div
        ...
        style={{ opacity: initialPill ? 0 : 1, transition: "opacity 0.6s cubic-bezier(0.22, 1, 0.36, 1)" }}
      >
        <div
        ...
        >
          <div className="flex items-center justify-between gap-6">
            <div className="text-white">
              <div className="text-lg md:text-3xl font-light tracking-wider">Jayvic</div>
              <div className="text-xs md:text-2xl font-bold tracking-[0.3em] uppercase">SAN ANTONIO</div>
            </div>
            <Link href="/work" className="pointer-events-auto px-6 py-2.5 md:py-3 bg-white text-black font-medium rounded-full hover:bg-white/90 transition-all duration-300 hover:scale-105 text-sm md:text-base">
              Work Experience
            </Link>
          </div>
        </div>
